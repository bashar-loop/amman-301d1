...
// you can use the return as well but its just one line of code !
...
let objectLit = () => ({key1:'value',key2:'value2',key3:'value3'});
...
// this here referes to the constructor function
// 2. What is "this" when joe.scopeArrow() is invoked?
// this here refers to the window which means this here is globally !
// 3. Explain why "this" is different when an arrow function is used.
// the prototype property does not exist for arrow functions.
// and because arrow functions can never be used as constructor plus
//Since it was not nested within a parent function, it uses the this value from the closest parent scope, which is the global scope.
